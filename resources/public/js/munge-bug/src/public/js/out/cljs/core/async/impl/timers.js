...
cljs.core.async.impl.timers.SkipListNode.cljs$lang$ctorPrWriter = (function (this__10848__auto__,writer__10849__auto__,opt__10850__auto__){return cljs.core._write.call(null,writer__10849__auto__,"cljs.core.async.impl.timers/SkipListNode");
});
...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_20894 = 0;while(true){
if((i_20894 < arr.length))
{(arr[i_20894] = null);
{
var G__20895 = (i_20894 + 1);
i_20894 = G__20895;
continue;
}
} else
...
cljs.core.async.impl.timers.SkipList.cljs$lang$ctorPrWriter = (function (this__10848__auto__,writer__10849__auto__,opt__10850__auto__){return cljs.core._write.call(null,writer__10849__auto__,"cljs.core.async.impl.timers/SkipList");
});
...
{var i_20901 = (self__.level + 1);while(true){
if((i_20901 <= (new_level + 1)))
{(update[i_20901] = self__.header);
{
var G__20902 = (i_20901 + 1);
i_20901 = G__20902;
continue;
}
} else
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_20903 = 0;while(true){
if((i_20903 <= self__.level))
{var links_20904 = (update[i_20903]).forward;if(((links_20904[i_20903]) === x__$1))
{(links_20904[i_20903] = (x__$1.forward[i_20903]));
{
var G__20905 = (i_20903 + 1);
i_20903 = G__20905;
continue;
}
} else
{{
var G__20906 = (i_20903 + 1);
i_20903 = G__20906;
continue;
}
}
...
*/
cljs.core.async.impl.timers.timeout = (function timeout(msecs){var timeout__$1 = ((new Date()).valueOf() + msecs);var me = cljs.core.async.impl.timers.timeouts_map.ceilingEntry(timeout__$1);var or__10281__auto__ = (cljs.core.truth_((function (){var and__10269__auto__ = me;if(cljs.core.truth_(and__10269__auto__))
{return (me.key < (timeout__$1 + cljs.core.async.impl.timers.TIMEOUT_RESOLUTION_MS));
} else
{return and__10269__auto__;
}
})())?me.val:null);if(cljs.core.truth_(or__10281__auto__))
...
cljs.core.async.impl.dispatch.queue_delay.call(null,((function (timeout_channel,or__10281__auto__,timeout__$1,me){
return (function (){cljs.core.async.impl.timers.timeouts_map.remove(timeout__$1);
return cljs.core.async.impl.protocols.close_BANG_.call(null,timeout_channel);
});})(timeout_channel,or__10281__auto__,timeout__$1,me))
,msecs);
