...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t20935 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t20935 = (function (val,box,meta20936){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t20935.cljs$lang$type = true;
cljs.core.async.impl.channels.t20935.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t20935";
cljs.core.async.impl.channels.t20935.cljs$lang$ctorPrWriter = (function (this__10848__auto__,writer__10849__auto__,opt__10850__auto__){return cljs.core._write.call(null,writer__10849__auto__,"cljs.core.async.impl.channels/t20935");
});
cljs.core.async.impl.channels.t20935.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t20935.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_20937){var self__ = this;
var _20937__$1 = this;return self__.meta20936;
});
cljs.core.async.impl.channels.t20935.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_20937,meta20936__$1){var self__ = this;
var _20937__$1 = this;return (new cljs.core.async.impl.channels.t20935(self__.val,self__.box,meta20936__$1));
});
cljs.core.async.impl.channels.__GT_t20935 = (function __GT_t20935(val__$1,box__$1,meta20936){return (new cljs.core.async.impl.channels.t20935(val__$1,box__$1,meta20936));
});
}
return (new cljs.core.async.impl.channels.t20935(val,box,null));
});
...
cljs.core.async.impl.channels.PutBox.cljs$lang$ctorPrWriter = (function (this__10851__auto__,writer__10852__auto__,opts__10853__auto__){return cljs.core._write.call(null,writer__10852__auto__,"cljs.core.async.impl.channels/PutBox");
});
...
cljs.core.async.impl.channels.ManyToManyChannel.cljs$lang$ctorPrWriter = (function (this__10848__auto__,writer__10849__auto__,opt__10850__auto__){return cljs.core._write.call(null,writer__10849__auto__,"cljs.core.async.impl.channels/ManyToManyChannel");
});
...
{self__.closed = true;
while(true){
var taker_20938 = self__.takes.pop();if((taker_20938 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_20938))
{var take_cb_20939 = cljs.core.async.impl.protocols.commit.call(null,taker_20938);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_20939,taker_20938,this$__$1){
return (function (){return take_cb_20939.call(null,null);
});})(take_cb_20939,taker_20938,this$__$1))
);
} else
{}
{
