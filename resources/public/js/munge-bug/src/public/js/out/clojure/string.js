...
{{
var G__13837 = cljs.core.pop.call(null,v__$1);
v__$1 = G__13837;
continue;
}
} else
...
{var pred__13841 = cljs.core._EQ_;var expr__13842 = limit;if(cljs.core.truth_(pred__13841.call(null,1,expr__13842)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__13841.call(null,2,expr__13842)))
...
var G__13844 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__13845 = (limit__$1 - 1);
var G__13846 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__13844;
limit__$1 = G__13845;
parts = G__13846;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___13848 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___13848))
{var replacement_13849 = temp__4090__auto___13848;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_13849)));
} else
{buffer.append(ch);
}
{
var G__13850 = (index + 1);
index = G__13850;
continue;
}
}
