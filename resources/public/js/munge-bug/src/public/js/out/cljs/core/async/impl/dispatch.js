...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_20929 = 0;while(true){
var m_20930 = cljs.core.async.impl.dispatch.tasks.pop();if((m_20930 == null))
{} else
{m_20930.call(null);
if((count_20929 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__20931 = (count_20929 + 1);
count_20929 = G__20931;
continue;
}
} else
{}
...
{}
cljs.core.async.impl.dispatch.queue_dispatcher = (function queue_dispatcher(){if(cljs.core.truth_((function (){var and__10269__auto__ = cljs.core.async.impl.dispatch.queued_QMARK_;if(and__10269__auto__)
